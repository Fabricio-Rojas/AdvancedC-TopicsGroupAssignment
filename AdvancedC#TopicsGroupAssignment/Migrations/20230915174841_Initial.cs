    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessPersons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BusinessPersons_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessPersons_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessPersons_BusinessId",
                table: "BusinessPersons",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessPersons_PersonId",
                table: "BusinessPersons",
                column: "PersonId");
